...
SELECT rating AS best_rating FROM review
...
SELECT dish_id, COUNT(dish_id) FROM categories_dishes GROUP BY dish_id HAVING COUNT(dish_id) >= 2;

SELECT dish.name AS dish_name, COUNT(categories_dishes.dish_id) AS dish_count 
FROM categories_dishes
JOIN dish ON categories_dishes.dish_id = dish_id 
GROUP BY categories_dishes.dish_id, dish.name 
HAVING COUNT(categories_dishes.dish_id) >= 2;

SELECT rating AS best_rating, review.description AS description
FROM review
